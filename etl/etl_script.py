...
def extract():
    ...
    with open(r"C:\Users\valen\Downloads\addresses.csv", "w") as output_file:
...
def transform():
    ...
    transformed_file = open(r"C:\Users\valen\Downloads\new_addresses.csv", "w")
    transformed_file.write("X,Y,Type\n")

    with open(r"C:\Users\valen\Downloads\addresses.csv", "r") as partial_file:
...
def load():
    ...
    in_table = r"C:\Users\valen\Downloads\new_addresses.csv"
